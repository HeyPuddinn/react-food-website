...
const Food = () => {
  ...
  return (
    <div className="mod-food">
      <div className="container">
        <div className="py-12 list-food last-mb-none  ">
            ...
            {foods.map((item, index) => (
              <div className="border shadow-lg item-food overflow-hidden duration-300 rounded-lg relative" key={index} data-price={item.price}>
                ...
                <div className="flex flex-col items-start justify-between px-2 py-4">
                  <div className="content w-full flex justify-between mb-6 flex-col md:flex-row">
                    <h2 className="font-bold text-h3 mb-2 md:mb-0 inline-block ">{item.name}</h2>
                    <p>
